-- V1.52 T-A P2: Extend work_profile enum to include 'essay'
-- First non-novel profile — essay-profile.md §2
--
...
CREATE TABLE works_new (
    ...
    work_profile TEXT DEFAULT NULL
        CHECK (work_profile IS NULL OR work_profile IN ('novel', 'essay')),
...
-- Step 5: Recreate all indexes (preserving original names from 20260604_works_table.sql)
