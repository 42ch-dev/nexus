-- Outbox Tables for nexus-sync (WS8 R4)
-- Previously inline DDL in crates/nexus-sync/src/outbox.rs
-- Now managed by sqlx::migrate for offline metadata consistency.
