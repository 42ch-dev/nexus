...
// prevents cross-creator routing — SEC-V131-01). fn input_schema(&self) -> &'static str { nexus_preset::capability_catalog::JUDGE_LLM_INPUT_SCHEMA } fn output_schema(&self) -> &'static str {
    r#"{
