...
#[async_trait]
impl Capability for NarrativeCompute { fn name(&self) -> &'static str {
    "narrative.compute"
} fn input_schema(&self) -> &'static str { nexus_preset::capability_catalog::NARRATIVE_COMPUTE_INPUT_SCHEMA } fn output_schema(&self) -> &'static str {
