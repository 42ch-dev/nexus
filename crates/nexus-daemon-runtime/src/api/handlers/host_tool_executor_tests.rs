    ...
    let req = ToolExecuteRequest {
        ...
        parameters: serde_json::json!({
            ...
            "blocks": [{
                ...
                "entry_id": "kb_write_1",
                "world_id": "wld_test_world",
                "owner": {"kind": "world", "id": "wld_test_world"},
    ...
    let req = ToolExecuteRequest {
        ...
        parameters: serde_json::json!({
            ...
            "blocks": [{
                ...
                "owner": {"kind": "world", "id": "wld_other_world"},
                "block_type": "character",
    ...
    let req = ToolExecuteRequest {
        ...
        parameters: serde_json::json!({
            ...
            "blocks": [{
                ...
                "owner": {"kind": "world", "id": "wld_other_creator_world"},
                "block_type": "character",
...
async fn manuscript_chapter_update_writes_content() {
    ...
    // Case-sensitive extension check is intentional: the fixture path is
    // generated by the handler under test (always lowercase); allowing
    // clippy::case_sensitive_file_extension_comparisons keeps the assertion
    // on the string form used by the rest of this test.
