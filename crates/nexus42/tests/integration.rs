...
// ── R-V144P0-009: audit-chapter CLI integration tests (DF-69) ──────────────

/// Test that `creator run audit-chapter --help` shows the subcommand help.
#[test]
fn audit_chapter_help_shows_mode_and_chapter() {
    Command::cargo_bin("nexus42")
        .unwrap()
        .arg("creator")
        .arg("run")
...
/// Test that `creator run audit-chapter` requires `--mode` and `--chapter`.
#[test]
fn audit_chapter_requires_mode_and_chapter() {
    Command::cargo_bin("nexus42")
        .unwrap()
        .arg("creator")
        .arg("run")
...
/// Test that `creator run audit-chapter` requires a `work_id` positional arg.
#[test]
fn audit_chapter_requires_work_id() {
    Command::cargo_bin("nexus42")
        .unwrap()
        .arg("creator")
        .arg("run")
