...
//!
//! `Request` body for `POST` /v1/daemon/strategies/{`strategy_id`}/transitions/patch (`V1`.71). `Rewires` an outer transition (linear next, conditional branch, or default target) and/or updates its condition label.
//!
//! `@schema_version` 1
