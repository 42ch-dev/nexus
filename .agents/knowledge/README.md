...
| [v1.7-delivery-compass-v1.md](v1.7-delivery-compass-v1.md) | V1.7 (2026-04-21) | V1.7 delivery compass: Residual Closure + ACP SDK Migration + Multi-Agent Worker + Capability Registry Sharing. 6 workstreams (WS-A–WS-F), 4 milestones (M1–M4), 11-entry regression gate (R33–R43), 9-entry risk register. | **Draft** — pending user confirmation |
