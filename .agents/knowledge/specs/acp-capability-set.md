...
| `nexus.workspace.paths` | yes | Enumerate allowed roots from the active preset: e.g. V1.15 `novel-writing` **`Stories/<StoryRef>/`**, **`.nexus42/references/<run-id>/`**, workspace `.agents/skills/`, and other policy-defined subtrees |
