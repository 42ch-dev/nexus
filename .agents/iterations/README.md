...
| [v1.30-residual-convergence-delivery-compass-v1.md](v1.30-residual-convergence-delivery-compass-v1.md) | V1.30 | **Active** — residual convergence (R14–R20), optional local-db hardening (R5–R9) |
