...
**Source:** Consolidated from all plans' residual findings (high, medium, low severity) + architecture alignment review (`.agents/knowledge/architecture-alignment-review.md`).
...
- Extract migration documentation to `.agents/archived/knowledge/outbox-schema.md`
...
**Source**: `.agents/knowledge/architecture-alignment-review.md` §2.6
...
**Priority**: Medium
**Source**: Architecture alignment review TD-7, `.agents/knowledge/architecture-alignment-review.md`
...
**Priority**: Medium
**Source**: Architecture alignment review TD-8, `.agents/knowledge/architecture-alignment-review.md`
...
**Priority**: Medium
**Source**: Architecture alignment review TD-10, `.agents/knowledge/architecture-alignment-review.md`
...
**Source**: `.agents/knowledge/architecture-alignment-review.md` §2.3, §2.6

#### Task 17: TD-11 — Complete missing CLI commands 🔶

**Priority**: Low
**Source**: Architecture alignment review TD-11, `.agents/knowledge/architecture-alignment-review.md`
...
**Priority**: Low
**Source**: Architecture alignment review TD-13, `.agents/knowledge/architecture-alignment-review.md`
