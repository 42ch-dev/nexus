...
**Supersedes**: [daemon-lifecycle-api-v1.md](../archived/knowledge/daemon-lifecycle-api-v1.md) — archived 2026-04-17 (v1 captured the gap and the "running-probe" minimal slice; it does not reflect the final full-FSM design).
**Coordinates with**:

- [orchestration-engine-v1.md](orchestration-engine-v1.md) — Phase 4 lands the HSM; engine is started/stopped by lifecycle state transitions (§3.2 / §10.5)
- [acp-client-tech-spec-v2.md](acp-client-tech-spec-v2.md) — Worker Manager graceful shutdown is keyed off `Stopping.entry`
- [architecture-alignment-review-v1.md](architecture-alignment-review-v1.md) — TD-9 resolution row updates to "Resolved (v2)" after Phase 4 merges
...
- Orchestration engine internals (see [orchestration-engine-v1.md](orchestration-engine-v1.md))
- ACP worker process model (see [acp-client-tech-spec-v2.md](acp-client-tech-spec-v2.md) §2.3)
...
- Start `_system.maintenance` Session on the orchestration engine (per [orchestration-engine-v1.md](orchestration-engine-v1.md) §9.1)
...
- Compile-time structure — daemon's state graph is **not user-configurable** (unlike presets, per [orchestration-engine-v1.md](orchestration-engine-v1.md) §1.2), so compile-time is a strength.

### 9.3 What we explicitly do **not** use statig for

- Preset execution — that's `graph-flow` territory and requires runtime-constructed graphs (see [orchestration-engine-v1.md](orchestration-engine-v1.md) §4.1).
...
### 10.1 Phase 4 scope (see [orchestration-engine-v1.md](orchestration-engine-v1.md) §10.5)
...
Phase 4 **can** start the moment `crates/nexus-orchestration` has its first shippable commit (so `OrchestrationEngine` trait exists for `Running.entry` to call). Running it in parallel shortens overall wall-clock; see [orchestration-engine-v1.md](orchestration-engine-v1.md) §10.1.
...
- [orchestration-engine-v1.md](orchestration-engine-v1.md) — sibling spec; lifecycle starts/stops the engine
- [acp-client-tech-spec-v2.md](acp-client-tech-spec-v2.md) — worker graceful shutdown keyed off `Stopping.entry`
- [architecture-alignment-review-v1.md](architecture-alignment-review-v1.md) — TD-9 row moves to "Resolved (v2)"
- [daemon-lifecycle-api-v1.md](../archived/knowledge/daemon-lifecycle-api-v1.md) — archived; do not rely on directly
