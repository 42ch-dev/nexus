...
| [schemas-boundary.md](schemas-boundary.md) | V1.4 WS5 (2026-04-17) | Wire vs local rule for `schemas/`. WS5 audit fully executed; npm version now 0.4.0. | Archived — WS5 fully executed |
