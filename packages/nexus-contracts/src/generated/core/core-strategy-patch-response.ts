...
/**
 * Core-owned Strategy patch result; identical wire shape to the existing Strategy patch response, including validation summary and optional side effects (single underlying definition (allOf to the existing schema; keep in sync through the P5-T0 schema lane)).
 */
export type CoreStrategyPatchResponse = NexusStrategyPatchResponse;
 ...
 */
export interface NexusStrategyPatchResponse {
  /**
