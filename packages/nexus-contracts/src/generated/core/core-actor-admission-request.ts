...
/**
 * Stored-data Actor admission request: closed ActorRef plus session viewpoint. Request-body ownership claims are never trusted; Rust mints the opaque AdmittedActor after stored validation.
 */
export interface CoreActorAdmissionRequest {
