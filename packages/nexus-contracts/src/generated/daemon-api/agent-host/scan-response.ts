...
export interface ScanResponse {
  /**
   * List of ACP agent entries annotated with local PATH-install status. Includes both registry-known agents and any custom-launch-command entries from the wizard.
   */
  agents: NexusAgentScanEntry[];
}
/**
