...
/**
 * Response for GET /v1/daemon/characters/{character_id}/tom. Bounded deterministic keyset page ordered (order, carrier_entry_id, row_ordinal); all-or-error, never a partial page.
 */
export interface ListCharacterTomResponse {
  items: NexusCharacterTomBeliefItem[];
 ...
 */
export interface NexusCharacterTomBeliefItem {
  /**
