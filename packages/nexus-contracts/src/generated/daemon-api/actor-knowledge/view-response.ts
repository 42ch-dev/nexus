...
/**
 * Response for POST /v1/daemon/actor-knowledge/view. All-or-error: never a partial page. Every item is already selected under the server-chosen read policy and carries the native holder_entry_id/disclosure projection.
 */
