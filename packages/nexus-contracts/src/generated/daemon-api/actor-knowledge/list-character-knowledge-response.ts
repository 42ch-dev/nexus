...
/**
 * Response for GET /v1/daemon/characters/:character_id/knowledge. Items are the admitted page under the server-chosen read policy, each carrying the native holder_entry_id/disclosure projection.
 */
