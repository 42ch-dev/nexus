...
- [orchestration-engine.md](../../specs/orchestration-engine.md) — Phase 4 lands the HSM; engine is started/stopped by lifecycle state transitions (§3.2 / §10.5)
...
- Orchestration engine internals (see [orchestration-engine.md](../../specs/orchestration-engine.md))
...
- Start `_system.maintenance` Session on the orchestration engine (per [orchestration-engine.md](../../specs/orchestration-engine.md) §9.1)
...
- Compile-time structure — daemon's state graph is **not user-configurable** (unlike presets, per [orchestration-engine.md](../../specs/orchestration-engine.md) §1.2), so compile-time is a strength.

### 9.3 What we explicitly do **not** use statig for

- Preset execution — that's `graph-flow` territory and requires runtime-constructed graphs (see [orchestration-engine.md](../../specs/orchestration-engine.md) §4.1).
...
### 10.1 Phase 4 scope (see [orchestration-engine.md](../../specs/orchestration-engine.md) §10.5)
...
Phase 4 **can** start the moment `crates/nexus-orchestration` has its first shippable commit (so `OrchestrationEngine` trait exists for `Running.entry` to call). Running it in parallel shortens overall wall-clock; see [orchestration-engine.md](../../specs/orchestration-engine.md) §10.1.
...
- [orchestration-engine.md](../../specs/orchestration-engine.md) — sibling spec; lifecycle starts/stops the engine
