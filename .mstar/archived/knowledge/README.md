...
| [schemas-boundary.md](schemas-boundary.md) | V1.4 WS5 (2026-04-17) | Wire vs local rule for `schemas/`. WS5 audit executed; paths updated to `schemas/cloud-sync/` in §5.2. **Layout SSOT:** [schemas-directory-layout.md](../../specs/schemas-directory-layout.md). | Archived — methodology + audit; layout superseded |
...
| [fl-d-conditional-routing-exploration-v1.35-prepare.md](fl-d-conditional-routing-exploration-v1.35-prepare.md) | V1.35 Prepare | FL-D exploration note from knowledge root. | Archived — superseded by [preset-conditional-routing.md](../../specs/preset-conditional-routing.md) |
