...
| [fl-d-conditional-routing-exploration-v1.35-prepare.md](fl-d-conditional-routing-exploration-v1.35-prepare.md) | V1.35 Prepare | FL-D exploration note from knowledge root. | Archived — superseded by [preset-conditional-routing-fl-d.md](../../knowledge/specs/preset-conditional-routing-fl-d.md) |
