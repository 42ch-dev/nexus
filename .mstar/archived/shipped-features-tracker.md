...
**Created**: 2026-05-30  
**Last updated**: 2026-06-16 (V1.48 closeout: 10 WL-A residuals closed; 18 other open lows bulk-deferred to V1.49; Profile B compaction done; integration `iteration/v1.48` ready for PR to `main`)
...
| ~~BL-10~~ | **Superseded** | V1.46 P1 (2026-06-15) | `docs/novel-writing-quickstart.md` retired. Content migrated to specs only: narrative happy path → [novel-author-experience.md](../knowledge/specs/novel-author-experience.md) §3; CLI workflow → [creator-run-preset-entry.md](../knowledge/specs/creator-run-preset-entry.md) (Shipped Master V1.45). Runtime remediation strings updated to cite spec paths. No replacement file; `docs/ARCHITECTURE.md` links to specs. Plan: [2026-06-14-v1.46-spec-cli-hygiene.md](../plans/2026-06-14-v1.46-spec-cli-hygiene.md). |
...
|---|---|
| **Theme** | **Novel Author Maturity & Spec Hygiene** — author desk delta (`creator works status --json` + per-finding remediation; novel-only gate; `findings_stale` opt-in) + spec tree hygiene (BL-10 quickstart retired → embedded §3 of `novel-author-experience.md`; 12 satellite spec amendments; cli-spec §6.2E deleted) + narrow runtime edges (on-disk chapter hints with cap=50 + tracing; dynamic clap `cli_args` for 3 first-slice presets) + hermetic supervisor research E2E (5 tests) + pool/inspiration mutation tracing (9 paths) |
...
| **Spec sweep (P0 fix-round)** | 8 active normative specs updated `reflection-loop` → `novel-chapter-review`: `novel-workflow-profile.md`, `novel-quality-loop.md`, `cli-spec.md`, `creator-run-preset-entry.md`, `orchestration-engine.md` (state machine + capabilities), `work-experience-model.md`, `novel-manuscript-audit.md`, `novel-author-experience.md` |
...
| **Active specs promoted** | [novel-findings-maturity.md](../knowledge/specs/novel-findings-maturity.md) (Draft V1.48 overlay) **folded** into [novel-quality-loop.md §9](../knowledge/specs/novel-quality-loop.md) at P-last. [novel-workflow-profile.md](../knowledge/specs/novel-workflow-profile.md) header updated to V1.48 Shipped (V1.48 §5.5.2 open-findings prompt injection + §5.5.4 AGENTS.md Layer 2 runtime). |
