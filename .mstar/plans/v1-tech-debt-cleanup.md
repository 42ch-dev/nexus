...
**Source:** Consolidated from all plans' residual findings (high, medium, low severity) + architecture alignment review (`.mstar/knowledge/architecture-alignment-review.md`).
...
**Evidence**: Tests passing; residual archived to `.mstar/archived/residuals/2025-04-05-context-assembly.json`
...
- Extract migration documentation to `.mstar/archived/knowledge/outbox-schema.md`
...
**Source**: `.mstar/knowledge/architecture-alignment-review.md` §2.6

**Closure**: TD-7 resolved (tests + knowledge). TD-8 / TD-10 waived with knowledge + code/doc pointers. TD-9: minimal `GET /v1/local/daemon/status` + tests + knowledge; full §10.1 state machine **out of scope** until V1.2+. Archive: `.mstar/archived/residuals/v1-tech-debt-cleanup-batch-d.json`.

#### Task 13: TD-7 — ForkBranch field naming consistency verification ✅

**Priority**: Medium
**Source**: Architecture alignment review TD-7, `.mstar/knowledge/architecture-alignment-review.md`
...
**Evidence**: [fork-branch-contract-alignment.md](archived/knowledge/fork-branch-contract-alignment.md) (archived 2026-04-17); `test_fork_branch_parent_branch_and_event_ids_roundtrip` in `crates/nexus-domain/src/contract_assertions.rs`.
...
**Priority**: Medium
**Source**: Architecture alignment review TD-8, `.mstar/knowledge/architecture-alignment-review.md`
...
**Evidence / decision**: Full merge deferred; rationale and follow-up in [dual-outbox-architecture.md](knowledge/dual-outbox-architecture.md). Archived as waived in `archived/residuals/v1-tech-debt-cleanup-batch-d.json`.
...
**Priority**: Medium
**Source**: Architecture alignment review TD-9, `.mstar/knowledge/architecture-alignment-review.md`
**Scope**: `crates/nexus-daemon-runtime`, spec `.mstar/knowledge/specs/cli-spec.md` §10.1
...
**Evidence**: `GET /v1/local/daemon/status` in `crates/nexus42d` (handler `daemon_status`, tests in `api/middleware.rs`, `tests/integration.rs`). Gap vs full FSM: [daemon-lifecycle-api-legacy.md](archived/knowledge/daemon-lifecycle-api-legacy.md) (archived 2026-04-17; full 6-state HSM design now in [archived/knowledge/daemon-lifecycle-api.md](archived/knowledge/daemon-lifecycle-api.md)).
...
**Priority**: Medium
**Source**: Architecture alignment review TD-10, `.mstar/knowledge/architecture-alignment-review.md`
...
**Source**: `.mstar/knowledge/architecture-alignment-review.md` §2.3, §2.6

#### Task 17: TD-11 — Complete missing CLI commands 🔶

**Priority**: Low
**Source**: Architecture alignment review TD-11, `.mstar/knowledge/architecture-alignment-review.md`
...
**Priority**: Low
**Source**: Architecture alignment review TD-13, `.mstar/knowledge/architecture-alignment-review.md`
