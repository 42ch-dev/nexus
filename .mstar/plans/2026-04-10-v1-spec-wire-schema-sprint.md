...
- **Coverage matrix** (committed under `.mstar/plans/2026-04-10-v1-spec-wire-schema-sprint.md): each **minimal-freeze-set** route family × **schema file** × **v1-spec anchor** × **platform plan id** (16–20) × status (done / gap / N/A).
