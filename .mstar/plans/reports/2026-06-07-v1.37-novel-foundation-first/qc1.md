...
- Finding ID: F-004
- Source Type: doc-rule | git-diff | manual-reasoning
- Source Reference: `novel-writing/workflow-profile.md` §5.3.2 lines 256-289; `crates/nexus-orchestration/embedded-presets/novel-writing/preset.yaml` lines 27-44
- Confidence: High
