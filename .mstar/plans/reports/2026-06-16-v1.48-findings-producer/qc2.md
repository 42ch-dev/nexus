...
- Tools run:
  ...
  - Read of plan, specs (novel-findings-maturity.md §1, novel-quality-loop.md §2.1/§8), key sources (review_report.rs, auto_chain.rs load/try_persist/persist_parsed, findings.rs FindingKind + create_finding_from_review + normalize + idempotent INSERT, preset_ids.rs)
