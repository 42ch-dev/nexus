...
- `novel-writing/author-experience.md` §3.4 (lines 86–99):
  - Header: “**V1.47 shipped**: Review preset produces findings per [novel-writing/quality-loop.md §8] (P0).”
...
- `novel-writing/workflow-profile.md` §5.5.6 (lines 756–773):
...
- Cross-link in `novel-writing/quality-loop.md` §3 table (line 63) and §8 (lines 123–149) are consistent.
...
- `novel-writing/workflow-profile.md` §5.5.4 (lines 705–714, normative):
...
- Cross-reference from `novel-writing/quality-loop.md` §4 (line 96): “See [novel-writing/workflow-profile.md §5.5.4] — V1.47 normative: Layer 2 = `Works/<work_ref>/AGENTS.md` …”
...
- Line 105 (preset chain): “`novel-chapter-review` | V1.47 P0: renamed from `reflection-loop` … See [novel-writing/quality-loop.md §8] …”
...
- `novel-writing/quality-loop.md:6`, `63` — header and table note the rename; active contract uses `novel-chapter-review`.
- `novel-writing/author-experience.md:88` — “replaces the former generic `reflection-loop` demo”.
- `novel-writing/workflow-profile.md:407`, `629`, `778`, `780`, `799`, `990` — either “replaces … demo”, roadmap scope notes, or inside the pre-V1.47 historical `<details>` block under §5.5.6; line 990 explicitly marks the old text “**superseded V1.47 P0**”.
- `novel-writing/manuscript-audit.md:24` — incidental historical mention in a different context.
...
- Per-file shortstats:
  ...
  - `novel-writing/quality-loop.md`: 1 file changed, 2 insertions(+), 2 deletions(-)
  - `novel-writing/workflow-profile.md`: 1 file changed, 2 insertions(+), 2 deletions(-)
