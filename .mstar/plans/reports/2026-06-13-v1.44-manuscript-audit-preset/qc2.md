...
## Source Trace
- Finding F-QC2-001: git-diff (run.rs handle_audit_chapter world_id check), preset.yaml (world_binding + extract_sync), spec `novel-writing/manuscript-audit.md` §3.2, orchestration test `worldless_work_returns_422_on_extract` (client-side simulation only). Confidence: High.
