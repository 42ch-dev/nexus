...
| AC3 | Every Part I command cross-checks against cli-spec / cli-command-ia | FAIL | 18/19 audited commands are supported by `cli-spec.md` / `cli-command-ia.md` or cited specs; `nexus42 creator run review-master <work_id>` is cited in `novel-writing/workflow-profile.md` §5.5.3 but is absent from current CLI and not listed in `cli-spec.md` / `cli-command-ia.md`. |
...
| qc3-F-001 | docs/novel-writing-quickstart.md:165 | `nexus42 creator run review-master <work_id>` | novel-writing/workflow-profile.md §5.5.3 | FAIL — write is present, but the command is not available in current `nexus42 creator run --help`; copy-paste validity fails AC1. |
| qc3-F-002 | docs/novel-writing-quickstart.md:249 | `### C) Work-Level Notes / Mid-Session Inspiration` + line 265 cross-ref | novel-writing/work-pool.md §3 | PASS |
...
| `nexus42 creator world create --title "Neon River"` | cli-spec.md §6.2G / novel-writing/workflow-profile.md §3.5.1.1 | PASS |
| `nexus42 creator world list` | cli-spec.md §6.2G / novel-writing/workflow-profile.md §3.5 | PASS |
| `nexus42 creator run start --idea ... --init-preset novel-project-init` | cli-spec.md §6.2D / novel-writing/workflow-profile.md §5.4 | PASS |
| `nexus42 creator works status` | cli-spec.md §6.2H / novel-writing/workflow-profile.md §8.1 | PASS |
...
| `nexus42 creator run reconcile-chapters <work_id>` | cli-spec.md §6.2D / novel-writing/workflow-profile.md §4.1.2 | PASS |
| `nexus42 creator run review-master <work_id>` | novel-writing/workflow-profile.md §5.5.3 / novel-writing/quality-loop.md §6 | FAIL — not present in live CLI `creator run --help`; not listed in cli-spec.md / cli-command-ia.md command tables |
| `nexus42 creator run start --idea "..." --init-preset novel-project-init --world-id <world_id>` | cli-spec.md §6.2D / §6.2G | PASS |
| `nexus42 creator works completion-lock release <work_id>` | cli-spec.md §6.2H / novel-writing/multi-work-lifecycle.md §3 | PASS |
| `nexus42 creator run resume <work_id> --reopen --reason "Adding epilogue"` | cli-spec.md §6.2D / novel-writing/multi-work-lifecycle.md §3.4 | PASS |
| `nexus42 creator works list` | cli-spec.md §6.2H / novel-writing/work-pool.md §5 | PASS |
| `nexus42 creator works use <work_id>` | cli-spec.md §6.2H / novel-writing/work-pool.md §5 | PASS |
| `nexus42 creator works pool list` | cli-spec.md §6.2H / novel-writing/work-pool.md §5 | PASS |
...
| 6 | `nexus42 creator world create --title "Neon River"` | `cli-spec.md` §6.2G lines 420-438; `novel-writing/workflow-profile.md` §3.5.1 | PASS |
| 7 | `nexus42 creator world list` | `cli-spec.md` §6.2G line 427; `novel-writing/workflow-profile.md` §3.5.1 | PASS |
| 8 | `nexus42 creator run start --idea ... --init-preset novel-project-init` | `cli-spec.md` §6.2D lines 350-378; `novel-writing/workflow-profile.md` §5.4 / §8 command map | PASS |
| 9 | `nexus42 creator works status` | `cli-spec.md` §6.2H lines 440-468; `novel-writing/workflow-profile.md` §8.1 | PASS |
...
| 12 | `nexus42 creator run reconcile-chapters <work_id>` | `cli-spec.md` §6.2D line 360; `novel-writing/workflow-profile.md` §4.1.2 / §8 command map | PASS |
...
| 14 | `nexus42 creator run start --idea "..." --init-preset novel-project-init --world-id <world_id>` | `cli-spec.md` §6.2D lines 372-378 + §6.2G lines 430-435; `novel-writing/workflow-profile.md` §8 command map | PASS |
| 15 | `nexus42 creator works completion-lock release <work_id>` | `cli-spec.md` §6.2H line 451; `novel-writing/multi-work-lifecycle.md` §3 | PASS |
| 16 | `nexus42 creator run resume <work_id> --reopen --reason "Adding epilogue"` | `cli-spec.md` V1.39 flags line 408; `novel-writing/multi-work-lifecycle.md` §3.4 | PASS |
| 17 | `nexus42 creator works list` | `cli-spec.md` §6.2H line 448; `novel-writing/work-pool.md` §5 | PASS |
| 18 | `nexus42 creator works use <work_id>` | `cli-spec.md` §6.2H line 450; `novel-writing/work-pool.md` §5 | PASS |
| 19 | `nexus42 creator works pool list` | `cli-spec.md` §6.2H line 452; `novel-writing/work-pool.md` §5; qc1-W-001 fix at line 220 remains present | PASS |
...
OK: CONTRIBUTING.md
OK: ARCHITECTURE.md
OK: ../.mstar/knowledge/specs/novel-writing/workflow-profile.md
OK: ../.mstar/knowledge/specs/novel-writing/work-pool.md
OK: ARCHITECTURE.md
...
[
  {
    "id": "R-V143P0-001",
    "title": "Spec overlay novel-writing/author-experience.md §2 row 4 references stale 'creator run status' (CLI has 'creator works status' per V1.41 cli-spec.md §6.2H); quickstart correctly uses the live command; P-last spec amendment needed",
    "severity": "low",
    "source": "qc1-W-002 (qc1.md initial wave); see also writing-specialist Completion Report §7 spec discrepancy note",
    "scope": ".mstar/knowledge/specs/novel-writing/author-experience.md §2 (Draft overlay V1.43)",
    "decision": "defer",
    "owner": "@fullstack-dev",
  ...
  {
    "id": "R-V143P0-002",
    "title": "Spec/CLI drift: novel-writing/workflow-profile.md §5.5.3 and novel-writing/quality-loop.md §6 reference the future 'review-master' surface (creator run review-master <work_id>), but the current CLI does not implement it; quickstart uses 'stage advance --stage review' as the available remediation path; P-last spec/CLI convergence",
    "severity": "low",
    "source": "QA verification (qa.md) AC1 fail; see also writing-specialist fix wave 2 Completion Report §9",
    "scope": ".mstar/knowledge/specs/novel-writing/workflow-profile.md §5.5.3 + .mstar/knowledge/specs/novel-writing/quality-loop.md §6 + nexus-daemon-runtime CLI subcommand surface",
    "decision": "defer",
    "owner": "@fullstack-dev",
