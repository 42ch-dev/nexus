...
|---------|------|--------|-------|
| `2026-07-03-v1.86-local-api-trust-hardening` | Local API Trust-Boundary Hardening (P0 holes + P1 same-class sweep) | InReview | Single plan, single feature branch, 2 batches. Impl HEAD `ec54e15a`; 2 regression-of-resolution residuals recorded (`R-V186-REGRESS-M004`, `R-V186-REGRESS-W001`). |
