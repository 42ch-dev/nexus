...
- **P-1 lives in specs + schemas + DESIGN.md**: `knowledge/specs/web-ui.md` new section, `schemas/local-api/reading/`, `apps/web/DESIGN.md` token stubs, `crates/nexus-local-db/migrations/` migration file (schema-only; no runtime code). No codegen run in P-1.
...
|-----------|--------------------------------|--------|
| Compass + plans locked (Phase 1 Review & Edit chain done) | 2026-07-04 | pending |
| P-1 Prepare complete (specify/clarify/plan locked) | 2026-07-04 | pending |
| P0 + P1 dev complete (parallel worktrees) | 2026-07-05 | pending |
| QC tri-review Approve | 2026-07-05 | pending |
| QA Pass | 2026-07-05 | pending |
| Iteration close + PR to `main` | 2026-07-06 | pending |
