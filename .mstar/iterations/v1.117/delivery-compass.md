...
| 2026-07-14-v1.117-mac-dock-icon | Mac Dock transparent icon | Done | Should (recommended close) |
| 2026-07-14-v1.117-button-voice-verb-only | Button voice Verb-only + DESIGN.md | Done | Must |
