...
|---------|------|--------|-------|
| `2026-07-09-v1.102-badge-soft-solid` | P0 — Badge soft / solid tone | Todo | Must. DESIGN + nexus-ui + Studio matrix. |
| `2026-07-09-v1.102-settings-shell` | P1 — Thin Settings host (DF-70 A) | Todo | Must. Host existing AgentPicker. |
| `2026-07-09-v1.102-ui-hygiene` | P2 — UI hygiene + Surfaces polish | Todo | Stretch. Whole-plan deferrable. |
...
| P0 Badge automated gates | 2026-07-10 | pending |
| P1 Thin Settings host automated gates | 2026-07-11 | pending |
| P2 Stretch (optional) | 2026-07-12 | pending |
...
- **Current iteration (V1.102):** Badge tone completeness + thin Settings host for AgentPicker; optional Surfaces polish Stretch.
...
- **Next iteration:** Fuller Settings IA / execution-mode settings if product prioritizes; remaining Stretch polish if deferred.
