...
|---------|------|--------|-------|
| `2026-07-10-v1.106-studio-first-pipeline` | P0 — Studio-first pipeline complete | Todo | Must |
| `2026-07-10-v1.106-first-launch-polish` | P1 — First-launch polish | Todo | Must; after/with P0 as capacity allows |
| `2026-07-10-v1.106-ui-continuity` | P2 — UI continuity polish | Todo | Stretch |
...
- **Current iteration (V1.106):** active scaffold — Studio-first pipeline Must + first-launch polish Must + continuity Stretch.
- **Next iteration:** Remaining P2 items not closed; further author-desk UI under studio-first invariant; DF-70 leftovers if promoted.
