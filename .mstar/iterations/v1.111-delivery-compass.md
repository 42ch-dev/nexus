...
|---------|------|--------|-------|
| 2026-07-12-v1.111-canvas-command-palette | P0 — Shared Canvas Command Palette (⌘K) | Todo | greenfield; file-disjoint; highest discoverability ROI |
| 2026-07-12-v1.111-sidebar-canvas-ia | P1 — Sidebar Canvas IA | Todo | `sidebar.tsx` local; coordinates with P0 action registry |
| 2026-07-12-v1.111-design-studio-canvas-gallery | P2 — Design Studio Canvas Surface Gallery | Todo | daemon-independent; fixture-driven; parallel-safe |
| 2026-07-12-v1.111-frontend-consolidation-sweep | P3 — Frontend Consolidation & UI Polish Sweep (Stretch) | Todo | architect-scoped residual selection at plan-lock; may defer to roadmap-next |
...
| P3 dev complete | 2026-07-12 | pending |
...
- **Current iteration (V1.111):** Canvas navigation + discoverability deepening (command palette + sidebar IA), Design Studio canvas gallery (studio-first closure), and frontend consolidation sweep. Four Must plans, all frontend, all `wire: false`.
- **Next iteration:** Graph layout engine (dagre/elk) for auto-layout on large graphs; Strategy inner-graph group `onConnect`; mass tech-debt archival pass (V1.91–V1.105). Trigger: V1.111 ships green and canvas navigation is proven. Owner: `@project-manager` + `@architect`.
- **Long-term Done:** Three canvas surfaces (Strategy, Outline+Timeline, World KB) are spatially complete, fully editable on-graph, **discoverable via ⌘K palette and nested sidebar IA**, **performant via auto-layout**, and **previewable in Design Studio under studio-first** — with a clean, drift-free frontend codebase.
...
|---------|-------------|---------|-----------|-----------------|
| 2026-07-12-v1.111-canvas-command-palette | TBD | TBD | TBD | `{PLAN_DIR}/2026-07-12-v1.111-canvas-command-palette.md#review-gate-summary` |
| 2026-07-12-v1.111-sidebar-canvas-ia | TBD | TBD | TBD | `{PLAN_DIR}/2026-07-12-v1.111-sidebar-canvas-ia.md#review-gate-summary` |
| 2026-07-12-v1.111-design-studio-canvas-gallery | TBD | TBD | TBD | `{PLAN_DIR}/2026-07-12-v1.111-design-studio-canvas-gallery.md#review-gate-summary` |
| 2026-07-12-v1.111-frontend-consolidation-sweep | TBD | TBD | TBD | `{PLAN_DIR}/2026-07-12-v1.111-frontend-consolidation-sweep.md#review-gate-summary` |
