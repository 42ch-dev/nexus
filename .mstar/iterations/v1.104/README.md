# V1.104 Iteration Workspace

**Status:** Phase 1 locked (architect §5.2; writing §5.3)  
**Must:** Settings **Workspace** path (W2) — post-setup folder change with honest restart/reload guidance.  
**Carry-forward:** V1.103 Stretch deferred; DF-70 execution-mode matrix remains Out.

| Path | Purpose |
|------|---------|
| [`specs/settings-workspace-section.md`](specs/settings-workspace-section.md) | W2 product + architecture locks (implementer SSOT) |
