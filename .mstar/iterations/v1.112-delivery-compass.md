...
|---------|------|--------|-------|
| 2026-07-12-v1.112-i18n-foundation | P0 — i18n foundation + Appearance | Todo | Must |
| 2026-07-12-v1.112-i18n-ui-migration | P1 — Full user-facing UI migration | Todo | Must; blocked_by P0 |
