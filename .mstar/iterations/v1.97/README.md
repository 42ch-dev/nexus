# V1.97 Iteration Workspace

Workspace for V1.97 Desktop First-Launch Reliability Hardening.
...
| Path | Purpose | Status |
|------|---------|--------|
| `guides/sidecar-startup-state-machine.md` | Architecture handoff for sidecar lifecycle invariants, prototype intake, and smoke evidence boundaries | active |
| `specs/` | Iteration-scoped draft spec notes if product/architecture review chooses to use them | empty |
