...
| `2026-07-06-v1.93-tls-robustness` | TLS Robustness (P0 — SAN invalidation on re-bind + graceful-shutdown grace cap; R-V192P0-001/002) | InReview | `@fullstack-dev`, `crates/nexus-daemon-runtime/`. Verified V1.92 shipped the production code; added 2 regression tests (`962d5847`); merged `ad049c97`. QC consolidated at P-last. |
| `2026-07-06-v1.93-remote-connection-polish` | Remote-Connection Polish + Desktop Tests (P1 — storage validation + fingerprint error copy + reconnect hint + desktop tests; R-V192P1-001/002/003 + R-V192UX-001) | InReview | `@frontend-dev`, `apps/web/` + `apps/desktop/`. Implemented (`b6c38e05`); merged `341cffa0`. QC consolidated at P-last. |
