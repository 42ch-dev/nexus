...
| Document | Role |
| --- | --- |
| [novel-quality-loop.md](../knowledge/specs/novel-quality-loop.md) | **Shipped (V1.47)** — wave 0; §8 `novel-chapter-review` output contract + `rule_suggestion` metadata |
| [novel-workflow-profile.md](../knowledge/specs/novel-workflow-profile.md) | **Shipped (V1.47)** — §5.5.4 two-layer rules (`AGENTS.md`); §5.5.6 normative reflection→findings |
| [novel-author-experience.md](../knowledge/specs/novel-author-experience.md) | **Shipped (V1.46)** — §3.4 reconciled in P3 (V1.47) |
