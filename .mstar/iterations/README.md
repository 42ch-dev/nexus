...
| [v1.37-novel-writing-foundation-delivery-compass-v1.md](v1.37-novel-writing-foundation-delivery-compass-v1.md) | V1.37 | **Active** — Novel Writing UX foundation-first; P0 targets init `preset.input` wiring, runtime `gates:` evaluation, scaffold atomicity, and first-run remediation; P1/P2/P3 roadmap multi-chapter DF-62, World KB DF-63, and quality-loop DF-64/65/66/67; no product implementation executed in prepare |
