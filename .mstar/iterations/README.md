...
| [v1.41-multi-work-author-desk-delivery-compass-v1.md](v1.41-multi-work-author-desk-delivery-compass-v1.md) | V1.41 | **Active** (prepare 2026-06-10) — DF-60 multi-work switch (P0 Medium ceremony) + DF-61 selection pool (P1 DB SSOT + inspiration MD refs) + P-last aggressive hygiene; multi-volume PK deferred V1.42; integration branch `iteration/v1.41` |
