...
| [v1.38-multi-chapter-serial-writing-delivery-compass-v1.md](v1.38-multi-chapter-serial-writing-delivery-compass-v1.md) | V1.38 | **Active** (2026-06-08) — DF-62 multi-chapter / serial writing implementation readiness; P0 chapter selection/status foundation (`next_chapter(work_id)`, DB-selected chapter 2..N, `current_chapter`, completion/status UX, tests); P1 `novel-writing` selected-chapter parameterization with one reusable preset; automatic continuation / auto-reenqueue, DF-53 full auto-chain, DF-63 World KB, DF-64/65/66/67 quality loop, multi-volume PK migration, platform publish, multi-work switch, and selection pool remain deferred |
