...
| [v1.50-novel-author-production-loop-and-world-kb-closure-delivery-compass-v1.md](v1.50-novel-author-production-loop-and-world-kb-closure-delivery-compass-v1.md) | V1.50 | **Active (prepare GO 2026-06-18)** — Novel Author Production Loop & World KB Closure: S-B dual track. Track A (T-A P0–P3) per-Work cron staggering (brainstorm 03/09/15/21 / write 04/10/16/22 / review :00/:30 defaults) + volume auto-chronology opt-in. Track B (T-B P0–P2) World KB editor CLI + review-time auto-promotion + refreshable scan. 9 plans registered: P-1 + 4 cron/chronology + 3 KB + P-last. Wave-0 overlays: [novel-writing/cron-staggering.md](../knowledge/specs/novel-writing/cron-staggering.md), [novel-writing/auto-chronology.md](../knowledge/specs/novel-writing/auto-chronology.md), [entity-scope-model.md](../knowledge/specs/entity-scope-model.md) §5.5 (Draft V1.50). Integration `iteration/v1.50` |
