...
| [v1.36-pending-delivery-compass.md](v1.36-pending-delivery-compass.md) | V1.36 | **Active** (2026-06-07) — novel-writing正文产出 UX; `work_profile: novel`; `Works/<work_ref>/` layout; prepare + P0–P4 plan stubs registered; DF-57/58 in-scope; DF-47 conditional; DF-59 publish OUT |
