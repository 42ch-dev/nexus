...
| [v1.33-work-experience-loop-delivery-compass-v1.md](v1.33-work-experience-loop-delivery-compass-v1.md) | V1.33 | **Active** — Work container, Creative Brief Intake, `creator run`, `llm_judge` fix, memory review loop |
