...
| [v1.40-novel-world-kb-delivery-compass-v1.md](v1.40-novel-world-kb-delivery-compass-v1.md) | V1.40 | **Active** (2026-06-10 prepare) — DF-63 World KB product closure: P0 world create + validation, P1 taxonomy, P2 prompt context block, P3 kb-extract binding, P4 V1.39 hygiene; integration branch `iteration/v1.40`; multi-volume PK, DF-60/61, platform publish OUT |
