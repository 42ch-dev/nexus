...
| [v1.40-novel-world-kb-delivery-compass-v1.md](v1.40-novel-world-kb-delivery-compass-v1.md) | V1.40 | **Shipped** (2026-06-11 via PR #52, MERGEABLE) — DF-63 World KB product closure: P0 mandatory world binding (post-user-clarification amendment), P1 BlockType + novel_category taxonomy + canonical_name grammar, P2 `{{ world_kb_block }}` prompt context, P3 kb-extract binding with `novel-review-master sync_world_kb`, P4 V1.39 hygiene (17 V1.40-tagged residuals closed: 9 resolved, 5 waived, 1 PM-accept, 3 out-of-scope); integration branch `iteration/v1.40` retired post-PR; multi-volume PK, DF-60/61, DF-56/47/59 stay deferred; 7 plans P-1 + P0.5 + P0–P4 all Done; 24 V1.40-tagged open residuals + R-V140P4-W2 PM-accept + R-V140P4-INFRA carry to V1.41 |
