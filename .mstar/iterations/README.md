...
| [v1.48-novel-quality-loop-completion-delivery-compass-v1.md](v1.48-novel-quality-loop-completion-delivery-compass-v1.md) | V1.48 | **Shipped (2026-06-16, P-last closeout)** — Novel Quality Loop Completion: F-D findings chain (P0 producer parse `review-report.md` → P1 consumer prompt injection → P2 `AGENTS.md` runtime + rules reset → P3 retention/NULL clear) + P4 serial §4.5.7 #4/#5 (S-B dual track with P0); pre-iteration hotfix R-V147P0-05 (closed in P0); 6 R-V147P0-* + R-V147P1-01 deferred to V1.49; P-last WL-A (10 V1.45/V1.46 lows all closed via surgical commits); overlay [novel-findings-maturity.md](../knowledge/specs/novel-findings-maturity.md) folded into [novel-quality-loop.md §9](../knowledge/specs/novel-quality-loop.md); 7 plans P-1 + P0 + P4 + P1 + P2-fix1 + P3 + P-last all Done; 18 other open lows bulk-deferred to V1.49; integration `iteration/v1.48` ready for PR to `main` |
