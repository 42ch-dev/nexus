...
> **Durable roadmap:** the phased removal (V1.60 suffix comment, V1.61+ drop) is consolidated in the [deferred-features tracker §2.6](../knowledge/deferred-features-cross-version-tracker.md) — DR-08.
