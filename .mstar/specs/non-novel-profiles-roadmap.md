# Non-Novel Profiles Roadmap — SUPERSEDED (archived)

| Attribute | Value |
| --- | --- |
| **Status** | **Superseded (2026-06-26)** — moved to archive; all targets shipped |
| **Document class** | Archived (pointer stub) |

**This Exploration is superseded; the full text moved to the archive.** All three target profiles have since shipped as Feature line specs:
- `game-bible` → [game-bible-profile.md](game-bible-profile.md) (Master, V1.55)
