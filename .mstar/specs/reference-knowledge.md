...
(reference refresh is reference-source-scoped, not KB-scoped). **Durable roadmap:** deferred-features tracker §2.6 — DR-07.
...
> **Durable roadmap:** consolidated in the deferred-features tracker §2.6 — DR-07 (refresh caps + CLI + E2E + cross-process OCC).
