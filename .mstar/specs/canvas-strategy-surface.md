...
> **V1.162 amendment (shipped) — fork authoring chrome (PD-5/PD-6).** The V1.162 compass ([`v1.162/delivery-compass.md`](../../iterations/v1.162/delivery-compass.md)) ships the author-facing half of `DF-V1122-FORK-UI` and promotes the fork chrome below from **spec-reserved to real** (read-only lineage chrome only — merge stays Non-Goal):
