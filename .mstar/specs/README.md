...
| [desktop-shell.md](desktop-shell.md) | Master | Electron target selected, **not yet shipped/qualified**; in-place product/host contract preserves setup/no-profile boot, guarded native actions, local-state recovery, HTTP client and three-option quit; defines secure preload/utility ownership and unsigned app+DMG for both macOS architectures. Tauri remains source baseline until replacement acceptance. |
