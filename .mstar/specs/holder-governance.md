...
> **Status:** Draft target (v1.191 architecture, 2026-09-18); not shipped. Current binaries use SPOKE 0.11.1 and `creator_only`. This contract becomes active only with the complete schema/reader/writer cutover below.
...
| `extract` | Not served remotely in this target; reject unsupported | Never advertise `ke-extraction` |
