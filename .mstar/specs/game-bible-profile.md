...
| Game-bible auto-chain | Optional stage sequencing for multi-section production — **Durable roadmap:** future work DR-41 | V1.54 preset stubs |
| Script profile scaffold | Follow game-bible pattern for script/dialogue Works (V1.55 P3 shipped) | V1.54 pattern validated |

---

*Draft V1.54 Feature line. Shipped as a Feature line; P-last promotes or revises.*
