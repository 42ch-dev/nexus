...
> **Durable roadmap:** DR-49 (compute-module ABI V2 bundle: multi-module composition/chaining, CDN distribution + Ed25519 signing, Generic Combat Protocol interop, 3P game-server bridge, KB→UI editor).
