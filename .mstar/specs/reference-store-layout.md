...
| **Related** | [v1.26 delivery compass §2](../../iterations/v1.26/delivery-compass.md#2-reference-storage-layout-normative-draft), [local-db-schema.md](local-db-schema.md), [entity-scope-model.md](entity-scope-model.md) |
