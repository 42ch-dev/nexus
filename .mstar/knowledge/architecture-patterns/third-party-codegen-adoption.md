...
- Shipped: [shipped-features-tracker.md § V1.138](../../roadmaps/shipped-features-tracker.md) — bespoke generators retired; library-driven `pnpm run codegen`; drift + workspace gates green.
