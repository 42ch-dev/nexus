...
**Created**: 2026-04-21  
**Last updated**: 2026-06-07 (V1.37 prepare: active compass created; integration branch `iteration/v1.37`; P0 foundation-first plan targets `R-V136P1-01`, `R-V136P1-02`, `R-V136P3-02`; P1/P2/P3 roadmap stubs registered for DF-62, DF-63, and DF-64/65/66/67 without marking them shipped)
...
| DF-62 | Multi-volume auto-chronology (per-volume outline + chapter range tracking) | V1.36 distill | **V1.37 P1 planned** | M | V1.36→V1.37 | V1.37 P1 plan [2026-06-07-v1.37-novel-multi-chapter-chronology.md](../plans/2026-06-07-v1.37-novel-multi-chapter-chronology.md) is registered to scope multi-chapter / multi-volume chronology after P0 foundation is stable. Open until implementation ships. |
...
*Last updated: 2026-06-07 (V1.37 prepare). Status: **V1.37 Active**; V1.36 Shipped 2026-06-07. V1.37 P0 targets `R-V136P1-01`, `R-V136P1-02`, and `R-V136P3-02`; DF-62/63/64/65/66/67 have roadmap plan stubs but remain open until implementation ships. DF-59 stays backlog; DF-47 and DF-56 stay conditional/out unless a future plan explicitly reopens them.*
