...
**Created**: 2026-04-21  
**Last updated**: 2026-06-08 (V1.37 P2: DF-63 spec-only roadmap amendments added to `entity-scope-model.md` §5.1.1 and `novel-workflow-profile.md` §3.5.1; implementation remains deferred to V1.37+ after P0/P1 stability)
...
| DF-64 | Findings lifecycle (review → brainstorm → write coordination; 3-role) | V1.36 distill | **V1.37 P3 roadmap / backlog implementation** | L | V1.36→V1.37 | V1.37 P3 roadmap [2026-06-07-v1.37-novel-quality-loop-roadmap.md](../plans/2026-06-07-v1.37-novel-quality-loop-roadmap.md) is registered. Implementation remains open until a narrow quality-loop slice is approved. Findings backplane should be local DB, not Redis. |
| DF-65 | Three-layer rules architecture (`writing-craft-rules.md` / `novel_rules.md` / `novel_rules_history.md`) | V1.36 distill | **V1.37 P3 roadmap / backlog implementation** | M | V1.36→V1.37 | V1.37 P3 roadmap is registered. Implementation remains open; future spec should define shared craft rules, per-work rules, and append-only rules history without duplicating SOUL or World KB. |
| DF-66 | Per-chapter log subdirectories (write/review/brainstorm/publish at `Works/<work_ref>/Logs/`) | V1.36 distill | **V1.37 P3 roadmap / backlog implementation** | S | V1.36→V1.37 | V1.37 P3 roadmap is registered. Implementation remains open; sync module MUST NOT scan logs as chapters. |
| DF-67 | Master-decision timeout (96h finding escalation) | V1.36 distill | **V1.37 P3 roadmap / backlog implementation** | S | V1.36→V1.37 | V1.37 P3 roadmap is registered. Implementation remains open; local DB scheduled task + `creator run status` banner is the likely OSS surface. |
...
*Last updated: 2026-06-08 (V1.37 P2 DF-63 roadmap amendment). Status: **V1.37 Active**; V1.36 Shipped 2026-06-07. V1.37 P0 closed `R-V136P1-01`, `R-V136P1-02`, and `R-V136P3-02`; DF-62 and DF-63 have roadmap-only spec amendments and remain open until implementation ships. DF-64/65/66/67 have roadmap plan stubs but remain open. DF-59 stays backlog; DF-47 and DF-56 stay conditional/out unless a future plan explicitly reopens them.*
