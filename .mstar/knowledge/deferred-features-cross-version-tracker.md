...
**Created**: 2026-04-21  
**Last updated**: 2026-06-10 (V1.40 PREPARE: compass + P0..P4 plans on `iteration/v1.40`; DF-63 targeted V1.40; V1.39 SHIPPED via PR #50; multi-volume PK remains deferred beyond V1.40)
...
| DF-63 | **World KB cross-Work unification** (was: Worldbuilding 7 sub-categories schema) | V1.36 distill → V1.36 spec §3.5 refactor | **V1.40 Active** (P0–P3 on `iteration/v1.40`) | L | V1.36→V1.37→V1.40 | V1.37 P2 roadmap shipped as spec; **V1.40** implements via [v1.40-novel-world-kb-delivery-compass-v1.md](../iterations/v1.40-novel-world-kb-delivery-compass-v1.md): P0 `creator world create` + validation ([2026-06-10-v1.40-world-create-and-validation.md](../plans/2026-06-10-v1.40-world-create-and-validation.md)), P1 taxonomy ([2026-06-10-v1.40-world-kb-taxonomy.md](../plans/2026-06-10-v1.40-world-kb-taxonomy.md)), P2 prompt block ([2026-06-10-v1.40-world-context-prompt-block.md](../plans/2026-06-10-v1.40-world-context-prompt-block.md)), P3 extract ([2026-06-10-v1.40-world-kb-extract-binding.md](../plans/2026-06-10-v1.40-world-kb-extract-binding.md)). Close row on P3 ship. |
