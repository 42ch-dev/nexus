...
**Quick status**: **V1.147 active (in-flight)** — direct compute lane shipped: Run Studio + compute-on-Timeline (DF-V1122-COMPUTABLE-UI + DF-V1122-COMPUTE-ON-TIMELINE closed → shipped archive); DF-V1122-DEEPER-WB event-row read slice landed (row open). Platform **paused**.
...
**Created**: 2026-04-21 · **Last updated**: 2026-08-01 (V1.147 — DF-V1122-COMPUTABLE-UI + DF-V1122-COMPUTE-ON-TIMELINE shipped; DF-V1122-DEEPER-WB event-row read slice landed)
