...
**Quick status**: **V1.101 active (Phase 1 iteration-start)** — Desktop setup polish + AgentPicker (Must) + Select stretch; Settings shell deferred as DF-70. V1.100 shipped (2026-07-09 via PR #130). Platform **paused**.
...
**Created**: 2026-04-21 · **Last updated**: 2026-07-09 (V1.101 §5.3 writing hygiene — DF-70 AgentPicker path; FEAT-WASM target no longer “Prepare active”)
...
| DF-70 | **App Settings shell** (sidebar IA + pages hosting reusable AgentPicker / execution-mode settings) | V1.101 | V1.102+ | M | V1.101 | V1.101 Must ships reusable app-shared `AgentPicker` at `apps/web/src/components/setup/agent-picker.tsx` (not `@42ch/nexus-ui`); no settings route/shell. BYOK remains out. Trigger: V1.101 Must Done + product priority. |
...
**Active iteration**: [V1.101](../iterations/v1.101-delivery-compass.md) (Phase 1 — Desktop setup polish + AgentPicker + Select stretch; `iteration/v1.101`).
