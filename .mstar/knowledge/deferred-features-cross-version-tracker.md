...
**Created**: 2026-04-21  
**Last updated**: 2026-06-08 (V1.37 P1: DF-62 spec-only roadmap amendment added to `novel-workflow-profile.md` §4.5/§8.1; implementation remains deferred to V1.37+ after P0 foundation stability)
...
| DF-63 | **World KB cross-Work unification** (was: Worldbuilding 7 sub-categories schema) | V1.36 distill → V1.36 spec §3.5 refactor | **V1.37 P2 roadmap** | L | V1.36→V1.37 | V1.37 P2 roadmap [2026-06-07-v1.37-novel-world-kb-roadmap.md](../plans/2026-06-07-v1.37-novel-world-kb-roadmap.md) is registered. **V1.36 refactor** remains: per-Work `Worldbuilding/` subtree is removed; world content lives in **World KB**. Still open: KB item schema, Work chapter正文 → World KB extraction, `world_refs` enforcement, and `creator world create` or equivalent. |
...
*Last updated: 2026-06-08 (V1.37 P1 DF-62 roadmap amendment). Status: **V1.37 Active**; V1.36 Shipped 2026-06-07. V1.37 P0 closed `R-V136P1-01`, `R-V136P1-02`, and `R-V136P3-02`; DF-62 has a roadmap-only spec amendment and remains open until implementation ships. DF-63/64/65/66/67 have roadmap plan stubs but remain open. DF-59 stays backlog; DF-47 and DF-56 stay conditional/out unless a future plan explicitly reopens them.*
