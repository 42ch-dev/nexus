...
**Quick status**: **V1.40 Active** (2026-06-10 P0+P3 shipped) · **V1.39 Shipped** (2026-06-09 via PR #50) · **V1.38 Shipped** · FL-E **Shipped in V1.34** · Platform **paused** · **V1.40 targets DF-63** (World KB P0+P3 shipped; P1–P2 pending) + **P4 hygiene** (17 V1.40-tagged residuals) · multi-volume PK deferred beyond V1.40 · Tech debt SSOT: [`status.json`](../status.json) — 66 open residuals; v1.40 hygiene = 17
...
**Created**: 2026-04-21  
**Last updated**: 2026-06-10 (V1.40 P3 shipped: kb-extract binding W5 complete; DF-63 P0+P3 shipped, P1–P2 pending)
...
| DF-63 | **World KB cross-Work unification** (was: Worldbuilding 7 sub-categories schema) | V1.36 distill → V1.36 spec §3.5 refactor | **V1.40 Active** (P0+P3 shipped; P1–P2 pending) | L | V1.36→V1.37→V1.40 | V1.37 P2 roadmap shipped as spec; **V1.40** implements via [v1.40-novel-world-kb-delivery-compass-v1.md](../iterations/v1.40-novel-world-kb-delivery-compass-v1.md) + [world-kb-runtime-architecture.md](world-kb-runtime-architecture.md). **P0 W1 (world create) + W4 (world_refs validation) Shipped** via [2026-06-10-v1.40-world-create-and-validation.md](../plans/2026-06-10-v1.40-world-create-and-validation.md). **P3 W5 (kb-extract binding) Shipped** via [2026-06-10-v1.40-world-kb-extract-binding.md](../plans/2026-06-10-v1.40-world-kb-extract-binding.md): `kb_extract_jobs` artifact locator migration (`source_kind`, `source_locator`, `profile_hint`, `work_id`), `finalize_extract` generic helper in `nexus-kb`, `kb.extract_work` capability V1.40 input schema, `WorkFields.world_id` + `build_child_kb_extract_schedule`, `--chapter N` CLI sugar, `novel-review-master` `sync_world_kb` state, 4 hermetic e2e tests. Remaining W2 (taxonomy body validation) / W3 (prompt context block) targeted P1–P2. Close row on P2 ship. |
