...
| DF-62 | Multi-chapter / serial writing + **multi-volume PK** | V1.36 distill | **V1.42 P1 Active** | M | V1.36→V1.38→V1.39→V1.41→V1.42 | Single-volume multi-chapter **shipped V1.38–V1.39**. **V1.42 P1**: PK `(work_id, volume, chapter)` + implicit `volume=1` backfill + cross-volume auto-chain + status data plane. Plan: [2026-06-11-v1.42-multi-volume.md](../plans/2026-06-11-v1.42-multi-volume.md). |
