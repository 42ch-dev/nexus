...
**Quick status**: **V1.40 Active** (2026-06-10 prepare on `iteration/v1.40`) · **V1.39 Shipped** (2026-06-09 via PR #50) · **V1.38 Shipped** · FL-E **Shipped in V1.34** · Platform **paused** · **V1.40 targets DF-63** (World KB P0–P3) + **P4 hygiene** (17 V1.40-tagged residuals) · multi-volume PK deferred beyond V1.40 · Tech debt SSOT: [`status.json`](../status.json) — 66 open residuals; v1.40 hygiene = 17

**Status**: Active (V1.40 prepare started; integration branch `iteration/v1.40`)  
...
**Created**: 2026-04-21  
**Last updated**: 2026-06-10 (V1.40 grill-me reuse pass: wire BlockType SSOT, P0.5 + P0..P4 plans revised on `iteration/v1.40`; DF-63 targeted V1.40; V1.39 SHIPPED via PR #50)
...
| DF-63 | **World KB cross-Work unification** (was: Worldbuilding 7 sub-categories schema) | V1.36 distill → V1.36 spec §3.5 refactor | **V1.40 Active** (P0.5 + P0–P3 on `iteration/v1.40`) | L | V1.36→V1.37→V1.40 | V1.37 P2 roadmap shipped as spec; **V1.40** implements via [v1.40-novel-world-kb-delivery-compass-v1.md](../iterations/v1.40-novel-world-kb-delivery-compass-v1.md) + [world-kb-runtime-architecture.md](world-kb-runtime-architecture.md). **Grill-me locked:** wire `BlockType` SSOT (entity-scope-model §5.1.1 revised); reuse `creator world` (P0 gap-fill), `fetch_world_kb` (P2), `kb.extract_work` (P3). Plans: P0.5 hygiene ([2026-06-10-v1.40-architecture-hygiene.md](../plans/2026-06-10-v1.40-architecture-hygiene.md)), P0 validation ([2026-06-10-v1.40-world-create-and-validation.md](../plans/2026-06-10-v1.40-world-create-and-validation.md)), P1 body validation ([2026-06-10-v1.40-world-kb-taxonomy.md](../plans/2026-06-10-v1.40-world-kb-taxonomy.md)), P2 chapter block ([2026-06-10-v1.40-world-context-prompt-block.md](../plans/2026-06-10-v1.40-world-context-prompt-block.md)), P3 extract extend ([2026-06-10-v1.40-world-kb-extract-binding.md](../plans/2026-06-10-v1.40-world-kb-extract-binding.md)). Close row on P3 ship. |
...
| DF-65 | Three-layer rules architecture | V1.36 distill | **V1.39 P3 Shipped** (path fix **V1.40 P0.5**) | M | V1.36→V1.37→V1.39→V1.40 | Plan: [2026-06-09-v1.39-rules-and-logs.md](../plans/2026-06-09-v1.39-rules-and-logs.md). Shipped V1.39: Layer 1 at `embedded-presets/rules/writing-craft.md` (interim); Layer 2/3 + `read_rules_layers()`. **V1.40 P0.5** migrates Layer 1 to `embedded-rules/` per spec §5.5.4. PR #50 merged ad9725d8. |
...
- **V1.40** (Active 2026-06-10): [v1.40-novel-world-kb-delivery-compass-v1.md](../iterations/v1.40-novel-world-kb-delivery-compass-v1.md) — **DF-63 World KB** P0–P3 + P4 hygiene on `iteration/v1.40`; multi-volume PK OUT.
