...
**Created**: 2026-04-21  
**Last updated**: 2026-06-08 (V1.37 P3: DF-64/65/66/67 spec-only roadmap amendment added to `novel-workflow-profile.md` §5.5; implementation remains deferred to V1.37+ when a future plan reopens)
...
| DF-62 | Multi-volume auto-chronology (per-volume outline + chapter range tracking) | V1.36 distill | **V1.37 P1 roadmap-only; implementation deferred to V1.37+ when P0 foundation is stable** | M | V1.36→V1.37<br>V1.37 P1 — spec-only amendment; implementation deferred to V1.37+ | V1.37 P1 plan [2026-06-07-v1.37-novel-multi-chapter-chronology.md](../plans/2026-06-07-v1.37-novel-multi-chapter-chronology.md) amended [novel-workflow-profile.md §4.5](specs/novel-workflow-profile.md#45-multi-chapter-and-multi-volume-semantics-v137-extension) and [§8.1](specs/novel-workflow-profile.md#81-multi-chapter-creator-run-status-ux-v137-extension) with roadmap-only multi-chapter semantics, `next_chapter(work_id)`, PK migration decision, volume outline minimum structure, status UX, and future tests. Open until implementation ships. |
...
- **V1.37** (Active 2026-06-07): [v1.37-novel-writing-foundation-delivery-compass-v1.md](../iterations/v1.37-novel-writing-foundation-delivery-compass-v1.md) — **Novel Writing UX foundation-first**: P0 targets init `preset.input` plumbing, runtime `gates:` evaluation, scaffold atomicity, and first-run remediation; P1/P2/P3 roadmap multi-chapter DF-62, World KB DF-63, and quality-loop DF-64/65/66/67. No product implementation executed in prepare.
...
*Last updated: 2026-06-08 (V1.37 Shipped). Status: **V1.37 Shipped** (2026-06-08); V1.36 Shipped 2026-06-07. V1.37 P0 closed `R-V136P1-01`, `R-V136P1-02`, and `R-V136P3-02`; P1/P2/P3 added roadmap-only spec amendments for DF-62, DF-63, and DF-64/65/66/67 (all remain open until implementation ships in V1.37+). New residual `R-V137P0-01` (serde strict-mode for misplaced YAML keys) opened at low severity. DF-59 stays backlog; DF-47 and DF-56 stay conditional/out unless a future plan explicitly reopens them. Next iteration (V1.38) TBD.*
