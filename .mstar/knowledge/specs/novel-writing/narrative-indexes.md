...
- [workflow-profile.md](workflow-profile.md) §4.2 (outline F### section), §3.1 layout
...
Explicit promotion from index rows to World KB remains **manual/opt-in** per [workflow-profile.md](workflow-profile.md) §3.5.1.5. V1.49 does not auto-sync index → World KB.

---

## 6. P-last merge

Fold into [workflow-profile.md](workflow-profile.md) new **§4.6 Narrative indexes (V1.49)**. Archive this overlay with supersede stub.
