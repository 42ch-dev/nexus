...
- **Body full-text editor + per-chapter edit lock** — **V1.67 lead authoring slice**. Lock design + MD round-trip + frontmatter sync + conflict policy. V1.66 renders body read-only. *(2026-06-26 update: this direction was **rejected** in the V1.67 re-discussion — Nexus is an AI-autonomous executor; the AI owns prose. The V1.68 lead is the **Canvas Strategy Surface** instead. See §15.3.)*
