...
**Scope**: Extended findings status lifecycle (F6) — supersedes three-state minimum in [novel-workflow-profile.md](novel-workflow-profile.md) §5.5.1 for V1.49 implement wave  
**Coordinates with**:

- [novel-quality-loop.md](novel-quality-loop.md) — merge target §2 at P-last
- [novel-author-experience.md](novel-author-experience.md) — §4 visibility surfaces
...
Fold §2–§3 into [novel-quality-loop.md](novel-quality-loop.md) §2. Archive this overlay with `Superseded by: novel-quality-loop.md §2 (V1.49)`.
