...
This project is indexed by GitNexus as **nexus** (8396 symbols, 19931 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
