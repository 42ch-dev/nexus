...
/** Pure historical predicate retained for fixture compatibility. */
export function canonicaliseEntitlements(value) {
...
export function compareEntitlements(signed, expected) {
  const problems = [];
