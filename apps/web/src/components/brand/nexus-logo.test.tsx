...
vi.mock('@42ch/nexus-ui/assets/logos/logo-primary-square.svg', () => ({
  default: '/mock/logo-primary-square.svg',
}));
...
describe('NexusLogo', () => {
  it('renders the primary plate lockup', () => {
    ...
    expect(logo.getAttribute('src')).toContain('logo-primary-square.svg');
