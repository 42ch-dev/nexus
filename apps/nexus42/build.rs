...
//! by scanning the nexus-preset embedded-presets directory.
//!
...
//!
//! **What it reads:** Embedded preset IDs from `crates/nexus-preset/embedded-presets/`.
...
//! on the preset loader from the CLI binary.
//!
//! **Contract:**
...
//! convention changes in nexus-preset, this build script will either
...
fn main() {
    ...
    println!("cargo:rerun-if-changed=../../crates/nexus-preset/embedded-presets");
